...
const CitySearch = () => {
  return (
    <div>
      <div class="flex">
        <div>
          <aside class="h-100 pb-10 mx-5 mt-10 mb-10  rounded-2xl w-80 bg-yellow-400   overflow-auto top-0 p-5">
            <div>
              <h1 className="text-2xl p-1"> city</h1>
              <input
                type="text"
                className="w-full px-5 py-1 rounded "
            ...
            <div>
              ...
              <button
                type="submit"
                className="w-full px-5 py-2 rounded-lg text-2xl mt-5 text-white bg-indigo-700 "
              >
                search
              </button>
            </div>
